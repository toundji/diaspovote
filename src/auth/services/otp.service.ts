...
export class OtpService {
    ...
    async sendConfirmOtp(user: User): Promise<void> {
        ...
        await this.redis.setex(redisKeys.otp('confirm', user.id), conf.otpTtl!, otp);
    ...
    async sendPinOtp(user: User): Promise<void> {
        ...
        await this.redis.setex(redisKeys.otp('pin', user.id), redisConf.confirm.otpTtl!, otp);
    ...
    async verifyOtp(operation: string, userId: string, otp: string): Promise<void> {
